...
import { View, Text, StyleSheet, FlatList, Dimensions, Pressable, Animated, Easing, useWindowDimensions, ImageBackground, SafeAreaView, StatusBar } from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.footer}>
        ...
        >
          <Ionicons name="arrow-back" size={24} color={index === 0 ? '#cbd5e1' : '#8B4513'} />
        </Pressable>
        ...
        <Pressable 
          ...
          style={({ pressed }) => [
            styles.navButton,
            index === slides.length - 1 && styles.navButtonFinal,
            pressed && styles.navButtonPressed
          ]}
        >
          <Ionicons 
            ...
            size={24} 
            color={index === slides.length - 1 ? '#fff' : '#8B4513'} 
          />
        </Pressable>
      </View>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#FAEAB1' },
  container: { flex: 1 },
  ...
  animWrap: { alignItems: 'center', justifyContent: 'center', marginBottom: 20, width: 160, height: 160 },
  pulse: { position: 'absolute', width: 140, height: 140, borderRadius: 70, backgroundColor: '#DCFCE7' },
  title: { fontSize: 28, fontWeight: '900', textAlign: 'center', marginBottom: 16, color: '#1e293b', textShadowColor: 'rgba(0, 0, 0, 0.1)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 },
  body: { color: '#475569', textAlign: 'center', paddingHorizontal: 24, fontSize: 17, lineHeight: 26, fontWeight: '500' },
  textWrap: { maxWidth: 520, alignSelf: 'center' },
  points: { gap: 16, paddingHorizontal: 20, width: '100%', maxWidth: 680, backgroundColor: 'white', borderRadius: 20, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 5, marginTop: 16 },
  point: { color: '#1e293b', textAlign: 'left', fontSize: 16, lineHeight: 24, flexShrink: 1, fontWeight: '500' },
  ...
  phoneFrame: { borderRadius: 28, overflow: 'hidden', borderWidth: 8, borderColor: '#fff', elevation: 8, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 16 },
  imageShade: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.3)' },
  imageCaption: { position: 'absolute', bottom: 16, left: 16, right: 16 },
  imgTitle: { color: 'white', fontWeight: '900', fontSize: 24, textShadowColor: 'rgba(0, 0, 0, 0.5)', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 4 },
  imgText: { color: 'white', marginTop: 8, fontSize: 16, textShadowColor: 'rgba(0, 0, 0, 0.5)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 3 },
  footer: {
    position: 'absolute',
    bottom: 24,
    left: 20,
  ...
  dotActive: { backgroundColor: '#D2691E', width: 24 },
  skip: { position: 'absolute', top: 20, right: 20, backgroundColor: 'white', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 6, elevation: 4 },
  skipText: { fontWeight: '800', color: '#8B4513', fontSize: 15 },
  navButton: {
    width: 44,
    height: 44,
    borderRadius: 22,
